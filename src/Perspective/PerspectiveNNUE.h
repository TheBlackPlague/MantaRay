...
namespace MantaRay
{
    ...
    template<typename  T,
             ...
             uint16_t           HiddenSize,
             uint16_t           OutputSize,
             uint16_t AccumulatorStackSize,
             T Scale, T QuantizationFeature, T QuantizationOutput>
    class PerspectiveNetwork
    {
        ...
        using Accumulator      = PerspectiveAccumulator<T, HiddenSize>;
        ...
        inline void EfficientlyUpdateAccumulator(const uint8_t piece, const uint8_t color, const uint8_t sq)
        {
            ...
            if (Operation == AccumulatorOperation::Activate)
                ...
                SIMD::SubtractFromAll(accumulator.White,
                                      accumulator.Black,
                                      FeatureWeight,
                                      whiteIndex * HiddenSize,
                                      blackIndex * HiddenSize);
