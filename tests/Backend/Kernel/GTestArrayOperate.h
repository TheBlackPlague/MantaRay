...
TEST(ArrayOperate, i08_512)
{
    ...
    MantaRay::ArrayOperate<MantaRay::Add, MantaRay::Add, MantaRay::Add, MantaRay::Sub, MantaRay::Sub>(
        a,
        a,
        a,
        a,
    ...
    for (MantaRay::usize i = 0; i < N; i++)
        EXPECT_EQ(a[i], static_cast<MantaRay::i08>(i % 2 == 0 ? 120 - 8 : 0));
}
...
TEST(ArrayOperate, i16_512)
{
    ...
    for (MantaRay::usize i = 0; i < N; i++)
        EXPECT_EQ(a[i], static_cast<MantaRay::i16>(i % 2 == 0 ? 120 - 8 : 0));
}
...
TEST(ArrayOperate, i08_2048)
{
    ...
    for (MantaRay::usize i = 0; i < N; i++)
        EXPECT_EQ(a[i], static_cast<MantaRay::i08>(i % 2 == 0 ? -228 : 0));
}
...
TEST(ArrayOperate, i16_2048)
{
    ...
    for (MantaRay::usize i = 0; i < N; i++)
        EXPECT_EQ(a[i], static_cast<MantaRay::i16>(i % 2 == 0 ? -228 : 0));
}
