...
TEST(ArrayAdd, i08_512)
{
    ...
    MantaRay::Backend::Kernel::Add(a, b);

    for (MantaRay::s00 i = 0; i < N; i++) EXPECT_EQ(a[i], static_cast<MantaRay::i08>(i % 2 == 0 ? 30 + 04 : 0));
}
...
TEST(ArrayAdd, i16_512)
{
    ...
    for (MantaRay::s00 i = 0; i < N; i++) EXPECT_EQ(a[i], static_cast<MantaRay::i16>(i % 2 == 0 ? 30 + 04 : 0));
}
...
TEST(ArrayAdd, i32_512)
{
    ...
    for (MantaRay::s00 i = 0; i < N; i++) EXPECT_EQ(a[i], i % 2 == 0 ? 30 + 04 : 0);
}
...
TEST(ArrayAdd, i08_2048)
{
    ...
    for (MantaRay::s00 i = 0; i < N; i++) EXPECT_EQ(a[i], static_cast<MantaRay::i08>(i % 2 == 0 ? -30 + 54 : 0));
}
...
TEST(ArrayAdd, i16_2048)
{
    ...
    for (MantaRay::s00 i = 0; i < N; i++) EXPECT_EQ(a[i], static_cast<MantaRay::i16>(i % 2 == 0 ? -30 + 54 : 0));
}
...
TEST(ArrayAdd, i32_2048)
{
    ...
    for (MantaRay::s00 i = 0; i < N; i++) EXPECT_EQ(a[i], i % 2 == 0 ? -30 + 54 : 0);
}
